...
using APBD__Cwiczenia9.Models;
using Microsoft.EntityFrameworkCore;

namespace APBD__Cwiczenia9.Data;

public partial class ApbdCw08Context : DbContext
{
    public ApbdCw08Context()
    {
    }

    public ApbdCw08Context(DbContextOptions<ApbdCw08Context> options)
        : base(options)
    {
    }
